#!/usr/bin/env python3
"""
Recupero codici sconto MediaWorld da shopilo.it
Sursa: https://shopilo.it/negozi/mediaworld.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/mediaworld.it"
STORE_NAME = "MediaWorld"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per MediaWorld da shopilo.it"""
    headers = {
