#!/usr/bin/env python3
"""
Fetch coduri de reducere MediaWorld de pe shopilo.it
Sursa: https://shopilo.it/magazin/mediaworld.it
"""
...
SHOPILO_URL = "https://shopilo.it/magazin/mediaworld.it"
STORE_NAME = "MediaWorld"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru MediaWorld de pe shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-mediaworld)"
    }
    try:
